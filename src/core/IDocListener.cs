...
namespace iTextSharp.text
{
    ...
    /**
     * A class that : <CODE>DocListener</CODE> will perform some
    ...
    public interface DocListener : IElementListener
    {
        ...
        bool SetPageSize(Rectangle pageSize); // [L4]
        ...
        bool SetMargins(float marginLeft, float marginRight, float marginTop, float marginBottom);  // [L5]
         ...
         */
        bool SetMarginMirroring(bool marginMirroring); // [L6]

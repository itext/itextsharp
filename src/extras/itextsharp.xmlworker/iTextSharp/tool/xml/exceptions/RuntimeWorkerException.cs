...
namespace iTextSharp.tool.xml.exceptions {
    ...
    public class RuntimeWorkerException : Exception {
         ...
         *
         */
        public RuntimeWorkerException() : base() {
        }
         ...
         * @param cause a cause
         */
        public RuntimeWorkerException(String message, Exception cause) : base(message, cause) {
        }

        /**
         * @param message a message
         */
        public RuntimeWorkerException(String message) : base(message) {
        }

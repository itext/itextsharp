...
namespace iTextSharp.tool.xml.exceptions {
    ...
    public class CssResolverException : Exception {
         ...
         *
         */
        public CssResolverException() : base() {
        }
         ...
         * @param cause a cause
         */
        public CssResolverException(String message, Exception cause) : base(message, cause) {
        }

        /**
         * @param message a message
         */
        public CssResolverException(String message) : base(message) {
        }

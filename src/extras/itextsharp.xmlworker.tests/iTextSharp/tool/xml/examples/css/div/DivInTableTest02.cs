...
{
    internal class DivInTableTest02 : SampleTest
    {
        ...
        protected override void MakePdf(string outPdf)
        {
            ...
            xmlHelper.ParseXHtml(writer, doc, new FileStream(inputHtml, FileMode.Open), null, null, new XMLWorkerFontProvider(), RESOURCES + @"\tool\xml\examples\css\div\divInTable02");
            doc.Close();
        }
    }
}

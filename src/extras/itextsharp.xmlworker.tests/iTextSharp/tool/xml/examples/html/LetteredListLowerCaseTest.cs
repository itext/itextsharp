...
{
    internal class LetteredListLowerCaseTest : SampleTest
    {
        ...
        protected override void MakePdf(string outPdf) {
            ...
            Document doc = new Document(PageSize.A4);
 		    ...
 		    doc.Open();
            FileStream cssFileStream = new FileStream(RESOURCES + @"\tool\xml\examples\html\letteredListLowerCase\" + "sampleTest.css", FileMode.Open, FileAccess.Read, FileShare.Read);

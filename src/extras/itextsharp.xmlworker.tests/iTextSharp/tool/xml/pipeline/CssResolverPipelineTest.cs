...
namespace itextsharp.xmlworker.tests.iTextSharp.tool.xml.pipeline {
    internal class CssResolverPipelineTest {
        ...
        virtual public void SetUp() {
            ...
            css.AddCss("dummy { key1: value1; key2: value2 } .aklass { key3: value3;} #dumid { key4: value4} .cjk { key5: \"宋体\", Helvetica ; key6:value6}", true);
	 ...
	 */
        ...
        virtual public void VerifyCssResolvedClass() {
            ...
            Assert.AreEqual("\"宋体\", Helvetica", css2["key5"]);
